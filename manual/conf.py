...
project = u'Manual del Desarrollador'
...
htmlhelp_basename = 'ManualdelDesarrolladordoc'
...
latex_documents = [
  ('index', 'ManualdelDesarrollador.tex', u'Manual del Desarrollador Documentation',
